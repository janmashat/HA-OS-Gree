# HA-OS Gree
# HA Gree custom integration that adds Horizontal Swing support
...
# Manual instalation:
1. copy all from gree to custom_components/gree_custom/<br>
2. restart HA<br>
...
DONE<br>
<br>
This integration is based on rapi3's fork of the original HA OS Gree Climate (patch from kspearrin)<br>
